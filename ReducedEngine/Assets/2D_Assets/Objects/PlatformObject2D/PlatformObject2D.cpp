#include "PlatformObject2D.h"
#include "../Assets/2D_Assets/RenderComponents/WireframeRenderComponent2D.h"

PlatformObject2D::PlatformObject2D(Transform2D transform)
{
	this->objectTransform = transform;
}

void PlatformObject2D::Initialize(RenderList* sceneRenderComponentList, PhysicsComponentList* physicsComponentList, AudioComponentList* audioComponentList, GUIComponentList* guiComponentList)
{
	this->isStatic = true;
