...
// Class that renders the sprite in 2D plane.

class SpriteRenderComponent2D : public RenderComponent2D
{
private:
	Shader* alphaTexShader = nullptr;
...
public:
	SpriteRenderComponent2D(Transform2D* transform) : RenderComponent2D(transform) {}
	...
	// Function to load the sprite.
	void LoadSpriteTexture(std::string fileLocation);
